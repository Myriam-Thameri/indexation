...
from ipynb.fs.full.Indexation import docs,all_words
from ipynb.fs.full.Indexation import Indexation
...
def main():
    ...
    if mot.lower():
        ...
        st.subheader('The most relevant documents.')
        sorted_df = df.sort_values(by='poids',ascending=False)
        st.table(sorted_df)
